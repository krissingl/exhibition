  ...
  return (
    <section id="hero" className="min-h-screen flex items-center pt-14">
      <div className="max-w-5xl mx-auto px-6 py-24">
        <p className="font-mono text-sky-400 text-sm mb-4">hello, I&apos;m</p>
        ...
        <div className="flex gap-4 flex-wrap">
          <a
            ...
            className="px-5 py-2.5 bg-sky-500 hover:bg-sky-400 text-neutral-950 font-semibold rounded transition-colors text-sm"
          >
            GitHub
          </a>
          {profile.linkedinUrl && (
